...
class VirtuCamProvider : ContentProvider() {
    ...
    override fun query(
        ...
        return when (uriMatcher.match(uri)) {
            CODE_CONFIG -> {
                MatrixCursor(arrayOf("enabled", "media_uri", "is_video", "is_stream", "stream_url", "target_apps", "compensation_factor", "is_mirrored", "zoom_factor", "rtsp_use_tcp", "rotation", "is_color_swapped")).apply {
                    addRow(arrayOf(
