        ...
        while (it.hasNext()) {
            ...
            try {
                eglCore!!.makeCurrent(es)
                 ...
                 // Restricted to native Xiaomi camera only - browsers/WebRTC handle rotation via metadata
                 if (isXiaomiCam && isCapture && sensorOrientation == 0 && contentH > contentW && vw > vh) {
                     applyRotation = 90
                 }
